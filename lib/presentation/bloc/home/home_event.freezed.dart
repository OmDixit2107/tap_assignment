...
class __$$LoadCompaniesImplCopyWithImpl<$Res>
    extends _$HomeEventCopyWithImpl<$Res, _$LoadCompaniesImpl>
...
class _$LoadCompaniesImpl implements LoadCompanies {
  ...
  @override
  String toString() {
    return 'HomeEvent.loadCompanies()';
  }
...
abstract class LoadCompanies implements HomeEvent {
...
class _$SearchCompaniesImpl implements SearchCompanies {
  const _$SearchCompaniesImpl({required this.query});
  ...
  @override
  String toString() {
    return 'HomeEvent.searchCompanies(query: $query)';
  }
...
abstract class SearchCompanies implements HomeEvent {
  const factory SearchCompanies({required final String query}) =
      _$SearchCompaniesImpl;
...
abstract class ClearSearch implements HomeEvent {
